...
void reportSamplePathStats(Flower *flower, FILE *fileHandle,
    ...
    stList *maximalHaplotypePaths = getContigPaths(flower, sampleEventString, eventStrings);
    ...
    traverseBlocks(flower, sampleEventString, eventStrings);
