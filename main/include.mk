...
sequences=${dataDir}/panTro3 ${dataDir}/NA12878 ${dataDir}/NA12892 ${dataDir}/NA19239 ${dataDir}/apd ${dataDir}/dbb ${dataDir}/mann ${dataDir}/nigerian ${dataDir}/qbl ${dataDir}/venter ${dataDir}/yanhuang ${dataDir}/NA19238 ${dataDir}/NA19240 ${dataDir}/cox ${dataDir}/hg19 ${dataDir}/mcf ${dataDir}/ssto ${dataDir}/Constraints1.fa ${dataDir}/Constraints2.fa ${dataDir}/Constraints3.fa ${dataDir}/Constraints4.fa ${dataDir}/Constraints5.fa ${dataDir}/Constraints6.fa ${dataDir}/Constraints7.fa ${dataDir}/Constraints8.fa ${dataDir}/Constraints9.fa ${dataDir}/Constraints10.fa ${dataDir}/Constraints11.fa ${dataDir}/Constraints12.fa ${dataDir}/Constraints13.fa ${dataDir}/Constraints14.fa ${dataDir}/Constraints15.fa ${dataDir}/Constraints16.fa ${dataDir}/Constraints17.fa ${dataDir}/Constraints18.fa ${dataDir}/Constraints19.fa ${dataDir}/Constraints20.fa
